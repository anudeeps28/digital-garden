---
aliases: [tech/fromquery-attribute]
type: atomic
...
## Source
Microsoft, introduced in ASP.NET Core (released 2016) as part of the model binding system for declarative parameter source binding.
