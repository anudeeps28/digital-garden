---
aliases: [tech/http-status-codes]
type: atomic
tags: [coding/web-api]
date: 2026-03-24
---
...
## Source
Internet Engineering Task Force (IETF), formalized in RFC 7231 (2014) as part of the HTTP/1.1 protocol specification; originated in HTTP/1.0 (RFC 1945, 1996).
